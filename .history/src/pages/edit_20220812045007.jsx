  ...
  return (
    <section className="bg-white my-[] lg:my-[2rem] py-[] lg:py-[2.5rem]">
      ...
      <article className="flex flex-col gap-[] lg:gap-[2rem] w-[75%] m-auto">
        {/* new post */}
        <div className="flex justify-end"></div> justify-end"></div>"></div>ssName="flex"></div>ssName="flex"></div>ssName="flex justify-end"></div> justify-end"></div> justify-end"></div> justify-end"></div> justify-end"></div> justify-end"></div> justify-end'>
