  ...
  return (
    <section className="bg-white my-[] lg:my-[2rem] py-[] lg:py-[2.5rem]">
      ...
      <article className="flex flex-col gap-[] lg:gap-[2rem] w-[75%] m-auto">
        ...
        {/* card title */}
        <textarea className="font-[600] bg-gray-300 p-[] lg:py-[1rem] lg:px-[4rem] text-[] lg:text-[1.4rem] rounded-[6px] shadow-md placeholder:italic" placeholder='Enter your post here'">
