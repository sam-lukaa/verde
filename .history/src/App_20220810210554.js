...
function App() {
  ...
  return (
    <>
      ...
      {/* card */}
      <>
        <section className="my-[3rem] flex flex-col lg:py-[2rem] gap-[] lg:gap-[2rem] w-[75%] m-auto bg-gray-100">
          {/* nav */}
          <nav className="flex justify-between bg-white p-[1rem]">
            <h3 className="font-[500]">Arbit Blog</h3>
            <div className="flex gap-[] lg:gap-[.8rem]">
              <h3>Posts<sup className='text-green-500 font-bold'>11</sup></h3>
              <figure>icon</figure>
              <figure>icon</figure>
              <figure>icon</figure>
            </div>
