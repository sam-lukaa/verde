...
function App() {
  const NavLink = () => {
    return (
      <>
          <Link to="/" className="hover:font-[500] hover:bg-gray-100 hover:transition hover:ease-in p-[.4rem] rounded-[6px] cursor-pointer"></Link>
    ...
    <main className=" bg-gray-100">
      ...
      <nav className="flex justify-between items-center bg-white p-[1rem] top-0 sticky">
        ...
        <div className="flex gap-[.7rem] lg:gap-[.8rem]">
          <Link to="/" className="hover:font-[500] hover:bg-gray-100 hover:transition hover:ease-in p-[.4rem] rounded-[6px] cursor-pointer">
            Posts <sup className="text-green-500 font-bold"> 11</sup>
          </Link>
          <figure className="hover:font-[500] hover:bg-gray-100 hover:transition hover:ease-in p-[.4rem] rounded-[6px] cursor-pointer">icon</figure>
          <figure className="hover:font-[500] hover:bg-gray-100 hover:transition hover:ease-in p-[.4rem] rounded-[6px] cursor-pointer">icon</figure>
          <figure className="hover:font-[500] hover:bg-gray-100 hover:transition hover:ease-in p-[.4rem] rounded-[6px] cursor-pointer">icon</figure>
        </div>
      </nav>
